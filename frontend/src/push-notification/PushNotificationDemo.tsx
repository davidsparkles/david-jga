...
const Loading = ({ loading }: { loading: boolean }) => (loading ? <div className="app-loader">Please wait, we are loading something...</div> : null);
...
export default function PushNotificationDemo() {
  ...
  return (
    <main>
      ...
      <button disabled={!pushNotificationSupported || !isConsentGranted || userSubscription != null} onClick={onClickSusbribeToPushNotification}>
